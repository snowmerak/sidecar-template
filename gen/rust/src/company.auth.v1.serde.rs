...
impl serde::Serialize for LoginRequest {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("company.auth.v1.LoginRequest", len)?;
        if !self.username.is_empty() {
...
impl<'de> serde::Deserialize<'de> for LoginRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct company.auth.v1.LoginRequest")
            }
        ...
        deserializer.deserialize_struct("company.auth.v1.LoginRequest", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for LoginResponse {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("company.auth.v1.LoginResponse", len)?;
        if !self.token.is_empty() {
...
impl<'de> serde::Deserialize<'de> for LoginResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct company.auth.v1.LoginResponse")
            }
        ...
        deserializer.deserialize_struct("company.auth.v1.LoginResponse", FIELDS, GeneratedVisitor)
    }
}
